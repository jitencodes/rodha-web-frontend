        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-6 xl:gap-8 items-center min-h-[426px]">
          <div
            className={cn(
              ...
              hasMedia ? "lg:col-span-6" : "lg:col-span-8",
              HERO_CONTENT_MAX,
              "lg:max-w-none"
            )}
          >
        ...
        <div className="bg-brand-orange/80 backdrop-blur-[12px] shadow-[0px_10px_20px_0px_rgba(0,0,0,0.25)] flex gap-5 p-2 lg:p-6 rounded-2xl lg:rounded-[22px] sm:absolute -bottom-10 lg:-bottom-17 translate-y-1/2 left-1/2 sm:left-auto w-fit mx-auto">
          <div className="flex gap-4.5">
            <svg
              ...
              aria-hidden
            >
              <g clipPath="url(#clip0_cat_hero_stats)">
                <path
                  d="M12.4183 27.2764C15.0277 27.2764 17.1472 25.1527 17.1472 22.5476C17.1472 19.9424 15.0277 17.8187 12.4183 17.8187C9.80901 17.8187 7.68945 19.9382 7.68945 22.5476C7.68945 25.1569 9.81323 27.2764 12.4183 27.2764ZM12.4183 19.8073C13.9299 19.8073 15.1586 21.036 15.1586 22.5476C15.1586 24.0591 13.9299 25.2878 12.4183 25.2878C10.9068 25.2878 9.67812 24.0591 9.67812 22.5476C9.67812 21.036 10.9068 19.8073 12.4183 19.8073Z"
                  fill="#552000"
                />
                <path
                  d="M6.98849 34.2347C6.98849 32.2038 8.63938 30.5487 10.6745 30.5487H14.1578C14.2634 30.5487 14.3647 30.5529 14.4661 30.5613C14.7532 30.5867 15.0403 30.4896 15.2514 30.2953C15.4541 30.1096 15.5681 29.852 15.5681 29.5733C15.5681 29.0667 15.1796 28.6318 14.6814 28.5811C14.5083 28.5642 14.3309 28.5558 14.1536 28.5558H10.6703C7.54161 28.5558 4.99561 31.1018 4.99561 34.2305V34.64H6.98427V34.2305L6.98849 34.2347Z"
                  fill="#552000"
                />
                <path
                  d="M15.9229 34.6442H17.9115V32.1953C17.9115 29.8984 19.782 28.028 22.0789 28.028H25.9211C28.218 28.028 30.0884 29.8984 30.0884 32.1953V34.6442H32.0771V32.1953C32.0771 30.118 31.0342 28.1926 29.2862 27.0484C28.2813 26.3898 27.116 26.0393 25.9211 26.0393H22.0789C20.1789 26.0393 18.4097 26.9049 17.2317 28.4122C16.3746 29.5058 15.9229 30.8146 15.9229 32.1953V34.6442Z"
                  fill="#552000"
                />
                <path
                  d="M37.3254 28.56H33.8421C33.745 28.56 33.6478 28.56 33.5507 28.5684C33.0145 28.598 32.5923 29.0371 32.5923 29.5649C32.5923 29.8393 32.7063 30.1011 32.9047 30.2911C33.1032 30.4769 33.365 30.574 33.6394 30.5571C33.707 30.5529 33.7745 30.5529 33.8421 30.5529H37.3254C39.3563 30.5529 41.0114 32.208 41.0114 34.2389V34.6484H43.0001V34.2389C43.0001 31.1102 40.4541 28.5642 37.3254 28.5642V28.56Z"
                  fill="#552000"
                />
                <path
                  d="M35.5814 27.2764C38.1908 27.2764 40.3103 25.1527 40.3103 22.5476C40.3103 19.9424 38.1865 17.8187 35.5814 17.8187C32.9763 17.8187 30.8525 19.9382 30.8525 22.5476C30.8525 25.1569 32.9763 27.2764 35.5814 27.2764ZM35.5814 19.8073C37.093 19.8073 38.3216 21.036 38.3216 22.5476C38.3216 24.0591 37.093 25.2878 35.5814 25.2878C34.0699 25.2878 32.8412 24.0591 32.8412 22.5476C32.8412 21.036 34.0699 19.8073 35.5814 19.8073Z"
                  fill="#552000"
                />
                <path
                  d="M23.9999 25.254C27.2806 25.254 29.949 22.5856 29.949 19.3049C29.949 16.0242 27.2806 13.3558 23.9999 13.3558C20.7192 13.3558 18.0508 16.0242 18.0508 19.3049C18.0508 22.5856 20.7192 25.254 23.9999 25.254ZM23.9999 15.3444C26.1828 15.3444 27.9603 17.122 27.9603 19.3049C27.9603 21.4878 26.1828 23.2653 23.9999 23.2653C21.817 23.2653 20.0394 21.4878 20.0394 19.3049C20.0394 17.122 21.817 15.3444 23.9999 15.3444Z"
                  fill="#552000"
                />
              </g>
              <defs>
                <clipPath id="clip0_cat_hero_stats">
                  <rect
                    width="38"
                    height="21.2884"
                    fill="white"
                    transform="translate(5 13.3558)"
                  />
                </clipPath>
              </defs>
            </svg>
