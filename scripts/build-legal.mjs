/**
 * Build legal.ts sections from fetched old-site policy text files.
 * Sources were previously saved via WebFetch during planning.
 */
...
const PRIVACY_POLICY = {
  ...
  sections: [
    ...
    section("personal-information", "1. Personal Information", [
    ...
    section("how-we-use", "3. How We Use and Share the Information Collected", [
    ...
    section("your-choices", "4. Your Choices", [
    ...
    section("your-rights", "5. Your Rights", [
    ...
    section("protection", "6. Protection of Your Information", [
      ...
      list([
        ...
        "a response to a court order, or other governmental request.",
      ]),
    ...
    section("third-party", "7. Third Party Websites", [
    ...
    section("cross-border", "8. Cross-Border Data Transfer", [
    ...
    section("duration", "9. Duration for Which Your Information Is Stored", [
    ...
    section("modification", "10. Modification to Privacy Policy", [
    ...
    section("grievances", "11. Grievances", [
      `If you have any questions about this Policy, wish to exercise your rights, concerns about privacy or grievances, please write to us with a thorough description via email to ${CONTACT.email}.`,
    ]),
    section("country-specific", "12. Country Specific Additional Rights", [
...
const TERMS_AND_CONDITIONS = {
  ...
  lastUpdated: "August 2026",
  description:
    "Terms and conditions governing use of the Rodha website, application, content, and related services.",
  sections: [
    section("introduction", "Introduction", [
    ...
    section("access-registration", "1. Access and Registration", [
    ...
    section("license", "2. License to Use", [
      ...
      list([
        ...
        "create derivative works or exploit any material made available on the Platform (including the Content and Creator Content) or any portion thereof in a manner that is not permitted under this license;",
    ...
    section("communications", "3. Communications", [
    ...
    section("code-of-conduct", "4. Code of Conduct", [
      "You agree to the following:",
      list([
        "Legitimate usage of the Platform: Use the Platform only for lawful purposes and do not engage in activity that violates applicable law or regulation.",
        "No harmful or dangerous content: Content which incites or promotes violence, that may cause physical or emotional harm or that may endanger the safety of any individual is prohibited.",
        "No hateful or defamatory content: We do not encourage or tolerate hate speech or statements that are libelous, slanderous, threatening, violent, predatory, or defamatory.",
        "No violent and graphic content intended solely to sensationalise, shock or disturb individuals.",
        "No harassment and bullying, including revealing someone's personal information or sexual harassment in any form.",
        "No spam: Posting untargeted, unwanted and repetitive content with an intention to spam a Public Forum or drive traffic to third-party sites is prohibited.",
        "No scams, extortion, or blackmail.",
        "Respect privacy of other Users as described in our Privacy Policy.",
        "No impersonation of another person, learner, company, institute, or group.",
        "No unauthorized access or disabling of the Platform, including denial-of-service attacks, malware, or interference with other users.",
      ]),
    ...
    section("intellectual-property", "5. Intellectual Property", [
    ...
    section("payments-refunds", "7. Payments and Refunds", [
    ...
    section("disclaimer", "8. Disclaimer", [
    ...
    section("limitation", "9. Limitation of Liability", [
    ...
    section("indemnity", "10. Indemnity and Release", [
    ...
    section("third-party-links", "11. Links to Third Party Website", [
    ...
    section("governing-law", "12. Governing Law and Jurisdiction", [
    ...
    section("contact", "14. Contact Us", [
      `If You've concerns or queries regarding this Agreement, You may write to us by email at ${CONTACT.email}.`,
    ]),
  ],
};

// Refund policy - structured from live rodha.co.in/refundpolicy
const REFUND_POLICY = {
  slug: "refund-policy",
  title: "Refund, Cancellation and Access Policy",
  lastUpdated: "01 April 2026",
  description:
    "Refund, cancellation and access rules for Rodha Educational Services Private Limited products and services.",
  sections: [
    section("introduction", "Introduction", [
    ...
    section("scope", "1. Scope of this Policy", [
      "This Policy applies to, including but not limited to:",
      list([
        "Live online batches",
        "Recorded courses",
        "Comprehensive courses and bundled programs",
        "Mock tests and test series",
        "Sectional tests",
        "Study material and physical booklets",
        "Workshop-based products",
        "Booster courses",
        "OMET, CAT, CLAT, IPMAT, SSC, GDPI and similar preparation products",
        "Any combo, upgrade, add-on, or bundled offering sold by Rodha",
      ]),
    ]),
    section("definitions", "2. Key Definitions", [
      list([
        '"Enrollment" — Successful purchase and confirmation of order.',
        '"Access" or "Access Activation" — Means the learner is able to log in and view, attend, attempt, download, stream, or otherwise use any part of the purchased product.',
        '"Use" — Includes, without limitation, attending a live class, viewing any recording, opening course content, joining any batch/group related to the course, downloading any file or material, attempting any mock/sectional/test, or availing any academic/support feature associated with the product.',
        '"Course Validity" — The maximum period for which access is available on the platform. It does not mean that the fee is charged on a month-wise basis, unless explicitly stated otherwise on the product page.',
        '"Physical Material" — Includes books, booklets, printed modules, or any other item shipped physically.',
        '"Bundled Product" — Any product sold as a package including two or more components such as live classes, recordings, mocks, study material, boosters, OMET modules, doubt support, strategy sessions, or physical material.',
      ]),
    ]),
    section("general-principle", "3. General Refund Principle", [
      ...
      list([
        "Non-attendance",
        "Non-login",
        "Non-attempt of mocks/tests",
        "Non-use of the remaining validity period",
        "Claiming refund merely because a portion of the validity period remains unused",
      ]),
    ]),
    section("product-wise", "4. Product-wise Refund Rules", [
    ...
    section("physical-material", "5. Physical Books and Study Material", [
      ...
      list([
        ...
        "Item received in materially damaged condition",
        "Item lost in transit and not delivered",
      ]),
    ...
    section("may-consider", "6. Cases Where Refund May Be Considered", [
      "Refunds may be considered only in limited situations such as:",
      list([
        "6.1 Duplicate Payment — If the learner is charged more than once for the same product due to a payment error, the duplicate amount may be refunded after verification.",
        "6.2 Failed Transaction with Wrongful Debit — If the amount is debited from the learner's account but the order is not created and Rodha actually receives the amount, the amount may be refunded after reconciliation.",
        "6.3 Non-Activation Due to Rodha-side Technical Failure — If the learner has successfully paid but Rodha fails to provide access within a reasonable time despite the learner reporting the issue through official support channels, Rodha may either activate access, or issue refund if the access failure is not resolved within a reasonable period.",
        "6.4 Product Cancellation by Rodha Before Commencement — If Rodha cancels a product before its commencement and does not provide a reasonable substitute, equivalent transfer, or credit option, Rodha may issue an appropriate refund.",
        "6.5 Material Non-Delivery or Material Service Failure Attributable to Rodha — If Rodha is unable to substantially deliver the purchased product for reasons attributable to Rodha and is unable to provide a reasonable alternative, extension, replacement access, or corrective resolution, Rodha may evaluate an appropriate remedy, which may include credit, extension, transfer, or refund, depending on the facts.",
      ]),
    ]),
    section("not-granted", "7. Situations Where Refund Will Not Be Granted", [
      "Refund shall ordinarily not be granted in the following situations:",
      list([
        "Change of mind after purchase",
        "Financial difficulty arising after purchase",
        "Lack of time to continue",
        "Preference for another course or institute",
        "Dissatisfaction based on personal expectation after availing access",
        "Inability to attend due to school, college, office, exam schedule, travel, health, or personal commitments",
        "Exam postponement, rescheduling, or policy changes by third-party exam bodies",
        "Low or minimal usage after access has already been granted",
        "Selective use of only some parts of a bundle",
        "Claim for refund of the unused validity period",
        "Internet issues, device issues, app/browser issues, or local connectivity issues not attributable to Rodha",
        "Suspension or removal due to violation of Rodha's academic, platform, or community rules",
        "Any request based on a claim that the learner did not fully utilize the course despite having valid access",
      ]),
    ]),
    section("goodwill", "8. Goodwill Support", [
    ...
    section("request-process", "9. Refund Request Process", [
      ...
      list([
        ...
        "Date of purchase",
        "Reason for request",
        "Relevant screenshots/documents, where applicable",
      ]),
      "Rodha may ask for additional information for verification.",
    ]),
    section("timelines", "10. Timelines for Raising Specific Issues", [
      list([
        "Duplicate payment / wrongful debit issues should be reported within 7 days of transaction.",
        "Access activation issues should be reported within 7 days of purchase or immediately upon noticing the issue.",
        "Physical material issues should be reported within 48 hours of delivery.",
      ]),
      "Delay in reporting may affect the ability to verify and process the claim.",
    ]),
    section("mode-timeline", "11. Refund Mode and Timeline", [
    ...
    section("chargebacks", "12. Chargebacks and Payment Disputes", [
    ...
    section("product-specific", "13. Communication of Product-Specific Terms", [
...
const DISCLAIMER = {
  ...
  lastUpdated: "August 2026",
  description:
    "Important disclaimers regarding Rodha's educational content, exam preparation information, outcomes, and third-party platforms.",
  sections: [
    section("general", "1. General Platform Disclaimer", [
    ...
    section("educational-content", "2. Educational and Exam Preparation Content", [
    ...
    section("results-outcomes", "3. Results, Selections and Student Outcomes", [
    ...
    section("course-information", "4. Course Information, Batches, Fees and Access", [
    ...
    section("external-platforms", "5. External Links and Partner Platforms", [
    ...
    section("limitation", "6. Limitation of Liability", [
    ...
    section("contact", "7. Contact", [
      `For questions about this Disclaimer, the Terms of Use, or related policies, write to ${CONTACT.email}. Related pages: Privacy Policy (/privacy-policy), Terms of Use (/terms-and-conditions), and Refund Policy (/refund-policy).`,
    ]),
  ],
};
...
function serializeContent(content) {
  return content
    .map((block) => {
      if (typeof block === "string") return JSON.stringify(block);
      if (block.type === "list") {
        return `{ type: "list" as const, items: ${JSON.stringify(block.items)} }`;
      }
      if (block.type === "ordered-list") {
        return `{ type: "ordered-list" as const, items: ${JSON.stringify(block.items)} }`;
      }
...
function serializePage(constName, page) {
  const sections = page.sections
    .map(
      ...
      content: [
        ${serializeContent(s.content)}
      ],
    }`
    )
    .join(",\n");

  return `export const ${constName}: LegalPageContent = {
  slug: ${JSON.stringify(page.slug)},
  title: ${JSON.stringify(page.title)},
  lastUpdated: ${JSON.stringify(page.lastUpdated)},
...
const file = `export interface LegalSection {
  id: string;
  title: string;
...
export const LEGAL_CONTACT = {
  ...
  grievanceOfficer: ${JSON.stringify(CONTACT.grievanceOfficer)},
};

${serializePage("PRIVACY_POLICY", PRIVACY_POLICY)}

${serializePage("TERMS_AND_CONDITIONS", TERMS_AND_CONDITIONS)}

${serializePage("REFUND_POLICY", REFUND_POLICY)}

${serializePage("DISCLAIMER", DISCLAIMER)}
...
fs.writeFileSync(path.join(ROOT, "src", "data", "legal.ts"), file);
console.log("Wrote src/data/legal.ts", file.length, "chars");
